...
namespace UniLibrary.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "ID", "Name", "Password", "StudentID" },
                values: new object[,]
                {
                    { 1, "Daniel Graham", "Password1", "19855666" },
                    { 2, "Eric Howell", "Password2", "19555661" },
                    { 3, "Patricia Lebsack", "Password3", "19555662" },
                    { 4, "Kalle Runolfsdottir", "Password4", "19555663" },
                    { 5, "Linus Reichert", "Password5", "19555664" }
                });
