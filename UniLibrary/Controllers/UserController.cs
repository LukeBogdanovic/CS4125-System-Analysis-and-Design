...
namespace UniLibrary.Controllers
{
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,StuName,StuID,UserType")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,StuName,StuID,UserType")] User user)
        {
            if (id != user.ID)
            {
                return NotFound();
